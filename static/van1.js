...
(async function init() {
	...
	renderCalendar();
	document.getElementById('prev').addEventListener('click', () => { monthOffset--; renderCalendar(); });
	document.getElementById('next').addEventListener('click', () => { monthOffset++; renderCalendar(); });
	updateBookingSummary();
})();
